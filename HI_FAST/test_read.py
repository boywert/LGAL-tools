...
def main():
    ...
    c = conn.cursor()
    c.execute("CREATE TABLE IF NOT EXIST Onion (Frequeny real, X real, Y real, Z real, R real, polar real, azim real, Vx real, Vy real, Vz real, Vr real, StellarMass real, ColdGas real, Mvir real)")
    conn.commit()
