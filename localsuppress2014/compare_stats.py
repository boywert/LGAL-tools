...
for i in range(len(model_names)):
    index = model_names[i]
    if not index in gal:
        (nTrees[index],nGals[index],nTreeGals[index],gal[index]) = readsnap_lgal_advance.readsnap_lgal(model_paths[i],file_prefix,firstfile,lastfile,filter,struct_file[index])
