...
def plot_xfrac():
    ...
    ax1.yaxis.grid(True,linestyle='-', color='k',alpha=0.1)
    ax2.xaxis.grid(True,linestyle='-', color='k',alpha=0.1)
    ax2.yaxis.grid(True,linestyle='-', color='k',alpha=0.1)
    ...
    fig.savefig("xfrachist.pdf",facecolor="white",bbox_inches='tight',pad_inches=0.1)
    plt.close(fig)
