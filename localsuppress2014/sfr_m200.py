...
def plot_z(z):
    ...
    for i in range(len(model_names)):
        ...
        sum_baryons[index] = numpy.histogram(numpy.log10(gal[index]["Mvir"]*1.e10),range=rangen,bins=bins,weights=(gal[index]["EjectedMass"]+gal[index]["ColdGas"])/gal[index]["Mvir"]/0.166)
