...
def plot_uv_z8():
    ...
    for i in range(len(model_names)):
        ...
        sum_SFR[index] = numpy.histogram(gal[index]["HaloM_Crit200"],bins=50,weight=gal[index]["Sfr"])
        sum_SFR_sq[index] = numpy.histogram(gal[index]["HaloM_Crit200"],bins=50,weight=gal[index]["Sfr"]**2)
